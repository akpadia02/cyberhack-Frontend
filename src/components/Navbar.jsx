                ...
                {isOpen && (
                    <div className="fixed inset-0 bg-black bg-opacity-50 z-50" onClick={() => setIsOpen(false)}>
                        ...
                        >
                            ...
                            <Link to="/" className="text-gray-700 text-lg hover:text-blue-500" onClick={() => setIsOpen(false)}>Home</Link>
                            <Link to="/about-us" className="text-gray-700 text-lg hover:text-blue-500" onClick={() => setIsOpen(false)}>About</Link>
                            <Link to="/news" className="text-gray-700 text-lg hover:text-blue-500" onClick={() => setIsOpen(false)}>News</Link>
                            <Link to="/contact" className="text-gray-700 text-lg hover:text-blue-500" onClick={() => setIsOpen(false)}>Contact</Link>
                            <Link to="/pricing" className="text-gray-700 text-lg hover:text-blue-500" onClick={() => setIsOpen(false)}>Pricing</Link>
                            
                            <SignedOut>
                                <SignInButton mode="modal">
                                    <button className="border px-6 py-2 rounded-md hover:bg-gray-100 w-full text-left">Log in</button>
                                </SignInButton>
                                <SignUpButton mode="modal">
